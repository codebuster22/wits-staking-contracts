export const WitsStakingAbi = [
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct WitsStaking.StakeInfo",
        "components": [
          {
            "name": "nftContract",
            "type": "address",
  ...
  {
    "type": "error",
    "name": "NotOwnerOrStakingAlreadyExists",
    "inputs": []
  },
  {
    "type": "error",
